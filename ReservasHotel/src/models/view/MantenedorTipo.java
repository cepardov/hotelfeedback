...
public class MantenedorTipo extends javax.swing.JFrame {
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        ...
        if (fila > -1){
            idtipo=Integer.parseInt(String.valueOf((tabla.getValueAt(fila, 0))));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MantenedorTipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MantenedorTipo().setVisible(true);
            }
        });
    }
